...
const ServicePage = () => {
    ...
    return (
        ...
        <ServiceHero />
        <div className="-mt-[8rem] lg:-mt-[5rem] mx-auto rounded-full bg-yellow-600 text-white h-40 w-40 cursor-pointer z-20" onClick={openModal}>
                <div className="flex items-center h-full w-full justify-center z-10" onClick={ () => console.log('open2')}>
        ...
        <section className="px-[5%] mt-[1rem] flex flex-col lg:justify-center service-container lg:mt-[2rem]">
            ...
            <Modal
                ...
                contentLabel=""
            >
                <button className="absolute top-0 right-0 -mt-3 -mr-3 w-5 h-5" onClick={closeModal}><img src="/cancel.svg" alt="close icon" /></button>
                <ModalContent />
            </Modal>
        </main>
  )
