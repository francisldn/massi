...
const ServicePage = () => {
  ...
  return (
    <main className='h-[100vh] w-full relative' id='modal'>
      <ServiceHero />
      <div
        className='-mt-[8rem] lg:-mt-[5rem] mx-auto rounded-full bg-yellow-600 text-white h-40 w-40 cursor-pointer z-20'
        onClick={openModal}
      >
        <div
      ...
      >
        <button
          className='absolute top-0 right-0 -mt-3 -mr-3 w-5 h-5 z-50 bg-black rounded-full overflow-hidden cursor-pointer'
